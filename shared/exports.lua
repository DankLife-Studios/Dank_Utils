...
CreateThread(function()
    ...
    local function checkComponents()
        return Framework.Status.Framework ~= 'none' and Framework.Status.Inventory ~= 'none' and Framework.Status.Banking ~= 'none' and Framework.Status.Target ~= 'none' and Framework.Status.Commands ~= 'none'
    end
    ...
    print(string.format("^2[^6DankLife Gaming ^2- ^0%s^2] %s\n^5Framework: ^3%s^0\n^5Inventory: ^3%s^0\n^5Banking: ^3%s^0\n^5Target: ^3%s^0\n^5Commands: ^3%s^0", 
        resourceName, statusMessage, Framework.Status.Framework or 'none', Framework.Status.Inventory or 'none', Framework.Status.Banking or 'none', Framework.Status.Target or 'none', Framework.Status.Commands or 'none'))

    local missingComponents = {}
    for _, component in pairs({{'Framework', Framework.Status.Framework}, {'Inventory', Framework.Status.Inventory}, {'Banking', Framework.Status.Banking}, {'Target', Framework.Status.Target}, {'Commands', Framework.Status.Commands}}) do
