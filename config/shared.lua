...
local manualSelection = { --- Set to 'AutoDetect' for automatic detection
    ...
    Target = 'AutoDetect', --- Manually specify a target system ('ox_target' or 'qb-target').
    Menu = 'AutoDetect', --- Manually specify a target system ('ox_lib' or 'qb-menu').
}
...
local forceQbMenu = GetConvar('ForceUseQbMenu', 'false') == 'true'
...
SharedConfig = {
    ...
    Menu = forceQbMenu and 'qb-menu' or ((manualSelection.Menu == 'AutoDetect') and detectedMenu or manualSelection.Menu),
}
